...
export default function PondLogTab({ pond, onUpdate }) {
  ...
  const handleSave = async () => {
    ...
    const withdrawalEndDate = form.medicine_used && form.withdrawal_days
    ...
    const newExpectedYield = (pond.survival_rate && pond.target_weight && newCurrentFish)
    ...
    loadLogs();
    setSaving(false);
    setForm(f => ({ ...f, dead_fish: 0, feed_amount: '', medicine_used: '', medicine_dosage: '', withdrawal_days: '' }));
  };
